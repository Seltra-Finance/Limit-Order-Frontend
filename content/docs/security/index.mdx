...
| Insufficient proceeds  | Signed minimum plus settlement balance-delta check            |
...
| Problematic tokens     | Owner-controlled allowlist policy                             |
...
Fee-on-transfer, rebasing, callback-bearing, and unreviewed tokens should not be allowlisted. Adapters should be added only after source review, live liquidity testing, and governance delay.
