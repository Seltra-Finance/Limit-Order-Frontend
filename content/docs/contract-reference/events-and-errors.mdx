...
* **Order validity:** `BadMaker`, `BadReceiver`, `OrderExpired`, `InvalidEpoch`, `PrivateOrder`, `BadFlags`
...
* **Policy:** `TokenNotAllowed`, `UnknownAdapter`, `FillsPausedError`
* **Authorization:** `NotGuardian`, `OnlySettlement`, `OnlyRouter`
* **Route validation:** `BadPath`, `BadRoute`, `BadTickSpacing`, `PoolNotAllowed`
